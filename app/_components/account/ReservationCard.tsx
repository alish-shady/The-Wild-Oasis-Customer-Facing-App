...
import { format, formatDistance, ISOFormatOptions, isPast, isToday, parseISO } from "date-fns";
  ...
  return (
    <div className="flex border border-primary-800">
      <div className="relative h-32 aspect-square">
        <Image src={image} alt={`Cabin ${name}`} className="object-cover border-r border-primary-800" />
      </div>
